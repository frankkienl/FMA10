...
object FmA10 {
    ...
    fun init(lpparam: XC_LoadPackage.LoadPackageParam) {
        //Thanks to ProGuard, the methodnames are obfuscated.
        val methodName = if (lpparam.packageName.endsWith("debug")) {
            "autoStartApp" //Debug
        } else {
            "a" //Prod
        }

        //For some reason, most class names are not obfuscated by ProGuard
